...
import AuthorI from '../public/profile.jpg'
         ...
         <section className="slider_sec">
            <Slider {...settings}>
               {sliderImages.map((image, index) => (
                  <div key={index}>
                     <Image src={image.src} alt={image.alt} layout="responsive" width={1920} height={1080} />
                  </div>
               ))}
            </Slider>
         </section>
                     ...
                     <div className="talk_sec">
                        ...
                        <div className="social_talk flex flex-center gap-1 mt-2">
                           <div className="st_icon">
                              <Link target="_blank" href="https://github.com/divyanshsaini962"><FaGithub /></Link>
                           </div>
                           <div className="st_icon">
                              <Link target="_blank" href="https://x.com/Divyans81637902?t=xGLy_ag_BVGY6_6UQZD7bQ&s=09"><FaXTwitter /></Link>
                           </div>
                           <div className="st_icon">
                              <Link target="_blank" href="https://www.instagram.com/mdivyansh.saini/?igsh=YzljYTk1ODg3Zg%3D%3D"><FaInstagram /></Link>
                           </div>
                        </div>
                     </div>
                  </div>

...
export default function Header() {
  ...
  const filteredBlogs = searchQuery.trim() === '' ?
    publishedblogs : publishedblogs.filter(blog => blog.title.toLower().includes(searchQuery.toLowerCase()))
  ...
  return <>
    <div className="header_sec">
      ...
      <div className={aside ? `navlist_mobile open` : 'navlist_mobile'}>
        ...
        <div className="logo">
          <Link href={"/"}><Image src={LogoLight} className="logoimg" width={150} alt="logo"/></Link>
        </div>
